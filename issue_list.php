    ...
    <form action="#" method="post" enctype="multipart/form-data">
      <table class="my-table" id="my-table" border="0">
        ...
        <tbody>
          <?php
            $sno=0;
		    $sql = "SELECT student.studentname,book.bookname,issue.admission_no,issue.bookcode,issue.doc FROM `student`,`book`,`issue` WHERE issue.admission_no=student.admission_no AND issue.bookcode=book.bookcode";
